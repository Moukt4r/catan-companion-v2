...
export const WORLD_EVENTS_CATALOG: readonly WorldEventDefinition[] = [
  ...
  worldEvent(
    "we-envoy",
    "Royal Envoy",
    "The player with the fewest public victory points chooses one resource from the bank. (Tied? Each tied player chooses one.)",
    "mixed",
    1,
    "diplomacy",
    "conditional",
  ...
  // ── Catch-up ───────────────────────────────────────────────────────────
  // These read the public victory point total the app already shows, never a
  // hidden hand. "Fewest" and "most" are therefore unambiguous at the table.
  worldEvent(
    "we-fair-shares",
    "Fair Shares",
    "The player with the fewest public victory points draws one random resource card from the player with the most. If either end is tied, the tied players roll one die and the highest roll takes part.",
    "mixed",
    2,
    "diplomacy",
    "conditional",
  ...
  worldEvent(
    "we-patronage-trade",
    "Merchant Patronage",
    "The player with the fewest public victory points draws one yellow progress card. (Tied? Each tied player draws one.)",
    "mixed",
    2,
    "society",
    "conditional",
  ...
  worldEvent(
    "we-patronage-politics",
    "Noble Patronage",
    "The player with the fewest public victory points draws one blue progress card. (Tied? Each tied player draws one.)",
    "mixed",
    2,
    "society",
    "conditional",
  ...
  worldEvent(
    "we-patronage-science",
    "Scholarly Patronage",
    "The player with the fewest public victory points draws one green progress card. (Tied? Each tied player draws one.)",
    "mixed",
    2,
    "society",
    "conditional",
  ...
  worldEvent(
    "we-land-grant",
    "Land Grant",
    "The player with the fewest public victory points takes two resources of their choice from the bank. The player with the most returns one resource of their choice to the bank.",
    "mixed",
    2,
    "diplomacy",
    "conditional",
  ...
  worldEvent(
    "we-favourable-winds",
    "Favourable Winds",
    "During its active round, the player with the fewest public victory points trades 2:1 with the bank in every resource.",
    "mixed",
    1,
    "economy",
    "conditional",
  ...
  worldEvent(
    "we-call-to-arms",
    "Call to Arms",
    "The player with the fewest public victory points activates one knight without paying grain.",
    "mixed",
    1,
    "military",
    "conditional",
  ...
  worldEvent(
    "we-discontent",
    "Discontent",
    "The player with the most public victory points returns one resource of their choice to the bank.",
    "setback",
    1,
    "diplomacy",
    "conditional",
  ...
  // ── Improvement tracks ─────────────────────────────────────────────────
  // Each discipline gets a pair: one rewarding investment, one helping the
  // players who have not invested yet, so neither leading nor trailing on a
  // track is a dead end.
  worldEvent(
    "we-great-library",
    "The Great Library",
    "Each player with science at level 2 or higher takes one paper from the bank.",
    "boon",
    2,
    "society",
    "conditional",
  ...
  worldEvent(
    "we-open-schools",
    "Open Schools",
    "Each player with science below level 2 takes one paper from the bank.",
    "boon",
    2,
    "society",
    "conditional",
  ...
  worldEvent(
    "we-guild-charter",
    "Guild Charter",
    "Each player with trade at level 2 or higher takes one cloth from the bank.",
    "boon",
    2,
    "economy",
    "conditional",
  ...
  worldEvent(
    "we-open-markets",
    "Open Markets",
    "Each player with trade below level 2 takes one cloth from the bank.",
    "boon",
    2,
    "economy",
    "conditional",
  ...
  worldEvent(
    "we-royal-audience",
    "Royal Audience",
    "Each player with politics at level 2 or higher takes one coin from the bank.",
    "boon",
    2,
    "diplomacy",
    "conditional",
  ...
  worldEvent(
    "we-common-council",
    "Common Council",
    "Each player with politics below level 2 takes one coin from the bank.",
    "boon",
    2,
    "diplomacy",
    "conditional",
  ...
  worldEvent(
    "we-flood",
    "Flood",
    "Hills (brick hexes) produce nothing during its active round.",
    "setback",
    2,
    "nature",
    "all",
  ...
  worldEvent(
    "we-caravan",
    "Caravan",
    "Each player may exchange one resource of their choice for a different resource from the bank.",
    "boon",
    1,
    "economy",
    "all",
  ...
  worldEvent(
    "we-muster",
    "Muster",
    "Each player with no active knight activates one basic knight for free.",
    "boon",
    2,
    "military",
    "conditional",
